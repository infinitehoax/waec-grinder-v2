...
## 2026-06-20 - [Collision-Free Navigation Shortcuts]
**Learning:** In Multiple Choice Question (MCQ) interfaces, standard shortcuts like 'B' for 'Back' collide with essential task inputs (Option B). This causes accidental navigation when users try to answer.
**Action:** Use 'P' (Previous) for backward navigation in study interfaces to ensure 'B' remains available for answering questions. Always sync visual <kbd> hints and aria-labels with the updated shortcut.
